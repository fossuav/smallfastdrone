...
function vehicle_control.maneuver.flip_start(axis, rate_degs, throttle_level, flip_duration_s, num_flips, slew_gain, true_hover_throttle, safety_params, climb_g)
  ...
  local accel_param_name = (axis == vehicle_control.axis.ROLL) and 'ATC_ACC_R_MAX' or 'ATC_ACC_P_MAX'
  local accel_max_degs2 = param:get(accel_param_name)
  if not accel_max_degs2 or accel_max_degs2 <= 0 then
    return nil, "Could not get valid ATC_ACC_*_MAX parameter"
  end
