...
#        self.takeoffAndMoveAway()
    ...
    def EK3_FlowAxisLockoutRecovery(self):
        ...
        def fly_with_stuck_flow_axis(options):
...
""")
    ...
    def EK3_PerCoreLogging(self):
        ...
        self.wait_ready_to_arm()
        self.takeoff(10, mode='GUIDED')
        # no event marks "the filter has settled on both source sets", so this is a
        # settle delay rather than a wait on something observable
        self.delay_sim_time(5, "let both lanes settle")
        self.do_RTL()
