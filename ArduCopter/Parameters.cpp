...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Values: 0:Stabilize,2:AltHold,3:Auto,4:Guided,5:LOITER,6:RTL,9:Land,17:Brake,18:Throw,29:VALT
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("THROW_SRC_SET", 22, ParametersG2, throw_srcset, 0),
    ...
    // @Values: 0:No change,1:Source1,2:Source2,3:Source3
    // @User: Advanced
    AP_GROUPINFO("THROW_SRC_INI", 23, ParametersG2, throw_src_init, 0),
#endif
