...
void Copter::ekf_check()
{
    ...
    // source switch (e.g. throw mode switching from GPS to no-aiding)
    // may legitimately lose position.  Without this reset, the failsafe
