...
- SRTM Height Sign Fix for Flow Scaling (https://github.com/ArduPilot/ardupilot/pull/34360)
...
10. #33569 AP_NavEKF3: make the optical-flow nav gain detune height configurable (EK3_FLOW_GAIN_H) - 3 files, comments only - no AI review
11. #33498 AP_NavEKF3: inhibit Z gyro bias from optical flow with no yaw reference - 4 files, approved by tridge, changes requested by rmackay9 - AI: approve (09-02)
